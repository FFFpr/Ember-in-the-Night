...
| [`tech/`](tech/) | **Technical routes planning has chosen to use** (brief “not selected” notes OK) — not demo build diaries, and not what the codebase currently ships. Present: [`art-style.md`](tech/art-style.md) (selected pixel look-dev route; demos in [`art_style_demo/`](../art_style_demo/)), [`gda.md`](tech/gda.md) (Godot Agent / Cursor MCP) |
