...
- Reference images under `art_style_demo/references/` (workshop FP, street day/night).
- `docs/tech/art-style.md`: direction locked; points at the demo brief.

### Todo

- Implement runnable demos (prefer order 01 → 02 → 04 → 03/05) per `art_style_demo/README.md`:
  - each approach: `workshop/workshop.tscn` + `street/street.tscn` (day 0–10s / night 10–20s)
  - `02` must reuse `01` layout
- Gather free/open art (license-checked) into `art_style_demo/shared/imported/` after placeholders.
