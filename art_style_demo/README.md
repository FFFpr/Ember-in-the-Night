...
| Runnable `.tscn` | **PR A compare pass:** `01` + `02` workshop/street use imported free packs under `shared/imported/`. `03`–`06` not started |
| Imported art packs | Done for PR A (Kenney, Calciumtrice, LPC Blacksmith/Ore, ambientCG Color maps) — see `shared/imported/CREDITS.md` |
