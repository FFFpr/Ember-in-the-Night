...
| Runnable `.tscn` | **PR C:** `04_locked_3d_camera` Compare pass (imported packs) |
| Imported art packs | Kenney Fantasy Town Kit, Quaternius Medieval Village (subset), OGA blacksmith + anvil |
